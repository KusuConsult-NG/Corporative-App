...
exports.approveGuarantorRequest = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        await sendNotification({
            ...
            message: `Your guarantor has approved your loan application for ₦${loan.amount.toLocaleString()}`,
            type: 'loan_update',
            data: {
                loanId: loanDoc.id,
        ...
        console.log(`✅ Guarantor approved loan ${loanDoc.id}`)
...
exports.rejectGuarantorRequest = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        await sendNotification({
            ...
            message: `Your guarantor has declined your loan application. ${reason ? `Reason: ${reason}` : ''}`,
            type: 'loan_update',
            data: {
                loanId: loanDoc.id,
        ...
        console.log(`❌ Guarantor rejected loan ${loanDoc.id}`)
