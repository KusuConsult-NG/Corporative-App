...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'AWSLMCSL Cooperative',
        short_name: 'AWSLMCSL',
        description: 'AWSLMCSL Joseph Sarwuan Tarka University Staff Multi-Purpose Cooperative Society Management System',
        theme_color: '#3b82f6',
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          // Icons will be auto-chunked by vite
        }
      }
    },
